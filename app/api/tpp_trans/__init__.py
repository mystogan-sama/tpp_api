...
respAndPayloadFields = {
    ...
    "nominal_beban_kerja": fields.Fixed(required=False, example="", ),
    ...
    "nominal_prestasi_kerja": fields.Fixed(required=False, example="", ),
    ...
    "nominal_kondisi_kerja": fields.Fixed(required=False, example="", ),
