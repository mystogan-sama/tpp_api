...
moduleTitle = ''
crudTitle = 'tpp_dashboard'
apiPath = 'tpp_dashboard'
modelName = 'tpp_dashboard'
respAndPayloadFields = {
    "id": fields.Integer(readonly=True, example=1, ),
    "parent_id": fields.Integer(example=1, ),
    "code": fields.String(required=False, max_length=100, example="1.01.01.", ),
    "name": fields.String(required=True, min_length=5, max_length=512, example="tpp_dashboard sample", ),
    "description": fields.String(required=False, example="Description sample", ),
    "penyetaraan": fields.Integer(example=1, ),
    ...
    "level": fields.Integer(example=1, ),
...
sortField = []
filterField = ["parent_id", "id", "id_unit", "asn", "struktur", "id_unitKerja", "level", "status", "dashboard", "Authorization"]
