...
class tpp_dashboard(db.Model):
    __tablename__ = f'{modelName}'
    id = db.Column(db.BigInteger, primary_key=True, autoincrement=True)
    # parent_id = db.Column(db.BigInteger, db.ForeignKey("tpp_dashboard.id"), nullable=True)
    ...
    #     primaryjoin="tpp_dashboard.id == tpp_kriteria_kerja.id_structural",
...
#     check_unit_and_employee_privilege_on_read_db(orm_execute_state, tpp_dashboard)
...
#         if isinstance(obj, tpp_dashboard):
...
# @event.listens_for(tpp_dashboard, 'after_insert')
...
#
#
# @event.listens_for(tpp_dashboard, 'after_update')
...
#
#
# @event.listens_for(tpp_dashboard, 'after_delete')
